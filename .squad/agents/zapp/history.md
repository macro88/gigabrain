...
- [2026-05-04T07:22:12.881+08:00] Once the active seam from a split final wave gets approved, the draft PR should drop it out of "in-flight" language immediately and restate the surviving last slice with its real gate constraints, so reviewers see one remaining product seam instead of stale half-complete framing.
