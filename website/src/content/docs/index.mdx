...
> **Phase 2 in progress.** Intelligence layer underway: graph traversal, contradiction detection, knowledge gaps, and the full MCP write surface. Phase 1 core storage, CLI, search, and MCP are complete. Build from source is available now.
