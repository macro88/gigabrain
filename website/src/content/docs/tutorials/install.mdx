...
You should see a version line like `quaid 0.x.y`. If `quaid: command not found`, ensure `~/.local/bin` is on your PATH (the installer prints a hint for your shell on success).
