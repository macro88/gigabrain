...
- [x] D.1 Import the 789-page PARA test vault (or a representative subset) and run
  `gbrain check --all`. Confirm zero false-positive contradictions from prose text.
- [x] D.2 Add a page with a proper `## Assertions` section and run `gbrain check --all`.
